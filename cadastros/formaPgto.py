...
master = Tk()
master.title("..:: Cadastro de Forma de Pagamento::..")
#master.iconbitmap(default=" ")
master.geometry("480x280+400+0") #Largura x Altura + dist. Esquerda + dist. direita

lblTitulo = Label(master,text= "Cadastro de forma de Pgto. ",font = "Calibri, 20",).place(x=140, y=5)


#Label Nome
lblNome = Label(master,text= "Forma de pagamento: ",font = "Calibri, 11",).place(x=25, y=55)
#TXT Nome

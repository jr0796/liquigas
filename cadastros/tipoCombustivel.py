...
master = Tk()
master.title("..:: Cadastro de combustível::..")
#master.iconbitmap(default=" ")
master.geometry("480x280+400+0") #Largura x Altura + dist. Esquerda + dist. direita

lblTitulo = Label(master,text= "Cadastro de Tipo de Combustível ",font = "Calibri, 20",).place(x=60, y=5)


#Label Nome
lblNome = Label(master,text= "Nome do combustível: ",font = "Calibri, 11",).place(x=25, y=55)
#TXT Nome
